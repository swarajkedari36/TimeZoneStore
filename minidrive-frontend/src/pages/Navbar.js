...
import { FiLogOut, FiUser, FiBarChart2, FiHome, FiUpload, FiSun, FiMoon, FiSearch, FiBell, FiSettings } from 'react-icons/fi';
    ...
    <nav style={{...styles.navbar, ...(darkMode ? styles.navbarDark : {})}}>
      <div style={styles.navContent}>
        ...
        <div style={styles.navLinks}>
          ...
          <div style={styles.userMenuWrapper}>
            ...
            {showUserMenu && (
              <div style={{...styles.userDropdown, ...(darkMode ? styles.userDropdownDark : {})}}>
                <button onClick={() => { navigate('/profile'); setShowUserMenu(false); }} style={styles.dropdownItem}>
                  <FiUser /> Profile
                </button>
                <button onClick={() => { navigate('/dashboard'); setShowUserMenu(false); }} style={styles.dropdownItem}>
                  <FiHome /> Dashboard
                </button>
                <button onClick={() => { navigate('/analytics'); setShowUserMenu(false); }} style={styles.dropdownItem}>
                  <FiBarChart2 /> Analytics
                </button>
                <div style={styles.dropdownDivider} />
                <button onClick={handleLogout} style={{...styles.dropdownItem, ...styles.dropdownItemDanger}}>
                  <FiLogOut /> Logout
                </button>
              </div>
            )}
          ...
          {/* Logout Button - Keep as fallback */}
